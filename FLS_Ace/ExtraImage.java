...
public class ExtraImage{
	...
	public ExtraImage(String name, ImagePlus image, String regex, String method, double sigma, double k) throws Exception{
		this.name = name;
		this.image = image;
		this.regex = regex;
		this.method = method;
	...
	private void checkImage() throws Exception{
		if(image==null){throw new Exception("ExtraImage ImagePlus missing for "+name);}
		if(image.getNDimensions()>2){throw new Exception("ExtraImage should only have 2 dimensions");}
	}
